...
#+hugo_base_dir: ../
#+hugo_section: posts/2026/01
#+author: derui

* ✨ RustでOperator Overloadを利用したDSLを作ってみる :programming:rust:
CLOSED: [2026-01-12 月 17:29]
:PROPERTIES:
:EXPORT_FILE_NAME: operator-overload-in-rust
:END:
...
1. lexer/parserを利用してparseを実装する
1. operator overloadとstructを駆使して頑張る
...
*** traitに対するimplか、traitの実装にたいするimplか

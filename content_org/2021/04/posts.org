...
#+HUGO_SECTION: posts/2021/04
#+AUTHOR: derui

* ✨ Emacsのinit.elをorgで書く方法と、変更時に楽をしてみる          :Emacs:
...
- https://orgmode.org/worg/org-contrib/babel/
  - org-babelのサイト
- [[https://taipapamotohus.com/posts/init_org/][Emacsの設定（その2）設定ファイル（init.el）をorg-modeで管理する]]
...
* ✨ Monadic ParserでSchemeのリストをパースする        :Programming:Scheme:

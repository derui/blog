...
lastmod = 2026-01-12T17:18:02+09:00
draft = false
+++
...
1.xから2.xへのupgradeは、 [migration guide](https://www.tensorflow.org/beta/guide/migration_guide)が作られています。この中で、upgrade scriptを用意してくれているので、これを流します。実行すると、report.txtというのが出てきます。
...
### name_scopeのre-entering廃止 {#name-scopeのre-entering廃止}

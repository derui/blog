...
lastmod = 2026-01-12T17:18:16+09:00
tags = ["OCaml"]
draft = false
+++

ちょっとしたCLI（ある程度出来たら記事にします）をOCamlで作っています。その際、初めて[ppx_let](https://github.com/janestreet/ppx_let)を使ってみたんですが、なかなか良かったので紹介します。

&lt;!--more--&gt;

[ppx_let](https://github.com/janestreet/ppx_let)は、OCaml界隈では知らない人のいない[Jane Street](https://www.janestreet.com/)社が公開しているPPX拡張です。
